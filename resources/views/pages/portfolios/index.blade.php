    ...
    <div class="container-fluid">
        <div class="px-3 bg-light rounded-3">
            <div class="container-fluid py-3">
                <h1 class="display-5 fw-bold">Portfolios</h1>
                            ...
                            @foreach ($portfolios as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="{{route('portfolios.destroy', [$item->id])}}" class="d-inline" onsubmit="return confirm('Apakah anda yakin ingin menghapus data ini?')">
                                        @csrf
