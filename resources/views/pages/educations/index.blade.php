    ...
    <div class="container-fluid">
        <div class="px-3 bg-light rounded-3">
            <div class="container-fluid py-3">
                <h1 class="display-5 fw-bold">Educations</h1>
                            ...
                            @foreach ($edus as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="{{route('edus.destroy', [$item->id])}}" class="d-inline" onsubmit="return confirm('Apakah anda yakin ingin menghapus data ini?')">
                                        @csrf
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('edus.update', $item->id) }}" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea rows="3" name="description" class="form-control" id="description" placeholder="Masukkan deskripsi">{{ $item->description }}</textarea>
                                                    </div>
                                                    <div class="form-group">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('edus.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                <label for="description">Description</label>
                                <textarea rows="3" name="description" class="form-control" id="description" placeholder="Masukkan deskripsi"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="since">Since</label>
